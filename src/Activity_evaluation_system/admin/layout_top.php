<?php
// ตรวจสอบตัวแปร active page และ breadcrumb
$current_page = $current_page ?? 'dashboard';
$page_title = $page_title ?? 'แผงควบคุมผู้ดูแลระบบ';
$breadcrumb_sub = $breadcrumb_sub ?? 'ภาพรวม';
    ...
    <div class="flex flex-1 relative">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 flex flex-col justify-between shrink-0 min-h-screen md:min-h-[calc(100vh-37px)] overflow-y-auto transform -translate-x-full md:translate-x-0 md:static md:inset-auto md:z-auto transition-transform duration-300 ease-in-out shadow-2xl md:shadow-none">
            <div>
                ...
                <!-- Navigation Menu -->
                <div class="px-4 py-4">
                    <p class="text-[11px] font-medium text-gray-400 uppercase tracking-wider mb-2 px-3">เมนูผู้ดูแลระบบ</p>
                    <nav class="space-y-1">
                        <!-- เมนู 1: ภาพรวม -->
                        <a href="index.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors <?= $current_page === 'overview' ? 'bg-[#fbf6ee] text-[#8a5823] font-semibold border-l-4 border-[#8a5823]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
                            <svg class="w-5 h-5 <?= $current_page === 'overview' ? 'text-[#8a5823]' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- เมนู 2: จัดการคำถาม -->
                        <a href="questions.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors <?= $current_page === 'questions' ? 'bg-[#fbf6ee] text-[#8a5823] font-semibold border-l-4 border-[#8a5823]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
                            <svg class="w-5 h-5 <?= $current_page === 'questions' ? 'text-[#8a5823]' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- เมนู 3: นักศึกษา -->
                        <a href="students.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors <?= $current_page === 'students' ? 'bg-[#fbf6ee] text-[#8a5823] font-semibold border-l-4 border-[#8a5823]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
                            <svg class="w-5 h-5 <?= $current_page === 'students' ? 'text-[#8a5823]' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- เมนู 4: ผลการประเมิน -->
                        <a href="results.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors <?= $current_page === 'results' ? 'bg-[#fbf6ee] text-[#8a5823] font-semibold border-l-4 border-[#8a5823]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
                            <svg class="w-5 h-5 <?= $current_page === 'results' ? 'text-[#8a5823]' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- เมนู 6: แดชบอร์ด -->
                        <a href="dashboard.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors <?= $current_page === 'chart_dashboard' ? 'bg-[#fbf6ee] text-[#8a5823] font-semibold border-l-4 border-[#8a5823]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
                            <svg class="w-5 h-5 <?= $current_page === 'chart_dashboard' ? 'text-[#8a5823]' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white border-b border-gray-200 px-4 sm:px-6 py-3 flex items-center justify-between text-xs text-gray-600">
                ...
                <div class="flex items-center gap-2 sm:gap-3 shrink-0">
                    <div class="flex items-center gap-1.5 text-gray-700 font-medium">
                        ...
                        <span class="hidden sm:inline"><?= htmlspecialchars($admin_name) ?></span>
                    </div>
