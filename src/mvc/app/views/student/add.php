...
<head> 
    ...
    <title>เพิ่มข้อมูลนักศึกษา — ระบบจัดการข้อมูลนักศึกษา</title> 
    ...
    <div class="max-w-xl mx-auto space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-xs border border-slate-200 overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-slate-200">
                <h1 class="text-lg font-bold text-slate-900">เพิ่มข้อมูลนักศึกษา</h1>
                <p class="text-xs text-slate-500 mt-0.5">กรอกข้อมูลรายละเอียดของนักศึกษาใหม่เพื่อบันทึกลงระบบ</p>
            </div>

            <!-- Form Body -->
            <form method="POST" action="index.php?action=store" class="p-6 space-y-4">
                
                <!-- รหัสนักศึกษา -->
                <div class="space-y-1.5">
                    <label for="StudentID" class="block text-xs font-medium text-slate-700">
                        รหัสนักศึกษา <span class="text-rose-500">*</span>
                    </label>
                    <input type="text" 
                           id="StudentID" 
                           name="StudentID" 
                           placeholder="เช่น 68642206001-8" 
                           required 
                           class="w-full px-3 py-2 rounded-lg border border-slate-300 text-slate-800 text-sm font-mono focus:border-slate-900 focus:ring-1 focus:ring-slate-900 transition-all outline-none placeholder:text-slate-400 placeholder:font-sans">
                </div>
